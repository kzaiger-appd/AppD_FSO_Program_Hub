...
export default function TodoCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setProjectVersion(initialValues.projectVersion);
    setBacklog(initialValues.backlog);
    setCcoActual(initialValues.ccoActual);
    setCcoCommit(initialValues.ccoCommit);
    setCcoTarget(initialValues.ccoTarget);
    setCsldUrl(initialValues.csldUrl);
    setIcDate(initialValues.icDate);
    setPlatform_type(initialValues.platform_type);
    setPsirtClosed(initialValues.psirtClosed);
    setPsirtOpened(initialValues.psirtOpened);
